...
#+name: attr_fit_width
#+begin_src sh :var data="" :var width_org_percent=90 width_html_pix=1200 :results output :exports none
  echo "#+attr_org: :width $width_org_percent%"
  echo "#+attr_html: :width $width_html_pix"
  echo "$data"
#+end_src
...
#+header: :post attr_fit_width(data=*this*)
#+begin_src plantuml :file ../images/afm_components.png :tangle code/afm_components.puml
  ...
  package " " <<layout>> as controller_logic {
    ...
    component "Cantilever Feedback Subsystem" as feedback_subsystem {
...
#+header: :post attr_fit_width(data=*this*, width_org_percent="80", width_html_pix="960")
